...
describe('updateTrackMediaInfo', () => {
	beforeEach(() => {
		...
		;(updateQueueTracks as jest.Mock).mockReturnValue(undefined)
	})
	...
	it('concurrent calls signal a cancellation and the ultimate request updates the player and queue store', async () => {
