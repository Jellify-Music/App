...
> = {
	...
	ocean: {
		dark: {
			background: 'rgba(0, 37, 63, 1)',
			background75: 'rgba(0, 37, 63, 0.75)',
			background50: 'rgba(0, 37, 63, 0.5)',
			background25: 'rgba(0, 37, 63, 0.25)',
			borderColor: '#78909C',
			color: '#ffffff',
			success: '#4DD0E1',
			secondary: '#81D4FA',
	...
	forest: {
		dark: {
			background: 'rgba(27, 55, 39, 1)',
			background75: 'rgba(27, 55, 39, 0.75)',
			background50: 'rgba(27, 55, 39, 0.5)',
			background25: 'rgba(27, 55, 39, 0.25)',
			borderColor: '#8D9E8C',
			color: '#ffffff',
			success: '#66BB6A',
			secondary: '#9CCC65',
	...
	sunset: {
		dark: {
			...
			background75: 'rgba(62, 39, 35, 0.75)',
			background50: 'rgba(62, 39, 35, 0.5)',
			background25: 'rgba(62, 39, 35, 0.25)',
			borderColor: '#A1887F',
			color: '#ffffff',
			success: '#FFAB91',
			secondary: '#FF8A65',
