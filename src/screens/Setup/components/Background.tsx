...
export const SetupBackground = () => {
    ...
    return (
        <>
            ...
            <VinylRecord
                style={[vinyl2Style, { position: 'absolute', top: -80, right: -80, width: 200, height: 200 }]}
                color={vinylColor2}
            />
            ...
            <WaveformBars
                style={[wave1Style, { position: 'absolute', top: '45%', left: '8%', opacity: isLight ? 0.25 : 0.35 }]}
                color={waveColor}
            />
            ...
            <LinearGradient
                colors={
                    isLight
                        ? ['rgba(255,255,255,0.4)', 'rgba(252,247,255,0.2)', 'rgba(255,255,255,0.3)']
