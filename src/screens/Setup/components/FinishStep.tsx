...
export const FinishStep: React.FC<Props> = ({ onFinish }) => {
	...
	useEffect(() => {
		...
		scale.value = withSequence(withDelay(200, withSpring(1.3, { damping: 8 })), withSpring(1))
			...
			>
				<View style={styles.content}>
					...
					>
						{/* Glow rings */}
						<View
							style={[styles.glowOuter, { backgroundColor: `${successColor}33` }]}
						/>
						<View
							style={[styles.glowInner, { backgroundColor: `${successColor}4D` }]}
						/>
