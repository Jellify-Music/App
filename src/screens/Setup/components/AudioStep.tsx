...
export const AudioStep: React.FC<Props> = ({ onNext }) => {
    ...
    const qualities = [
        { label: 'Original', sub: 'Lossless Quality', value: StreamingQuality.Original, icon: 'network' },
        { label: 'High', sub: '320kbps AAC', value: StreamingQuality.High, icon: 'network-strength-4' },
        { label: 'Medium', sub: '256kbps AAC', value: StreamingQuality.Medium, icon: 'network-strength-3' },
        { label: 'Low', sub: '128kbps AAC', value: StreamingQuality.Low, icon: 'network-strength-1' },
    ]
                ...
                <View style={styles.content}>
                                    ...
                                    >
                                        <View style={styles.qualityContent}>
                                            ...
                                            <View style={[
                                                ...
                                                {
                                                    backgroundColor: isSelected 
                                                        ? (isLight ? 'rgba(109, 47, 255, 0.25)' : 'rgba(255,255,255,0.25)')
                                            ...
                                            <View style={styles.qualityTextContainer}>
                                                ...
                                                <Text style={[styles.qualitySub, { color: textColor }]}>
                                                    {q.sub}
                                                </Text>
                                            </View>
                    ...
                    <Animated.View entering={FadeInDown.delay(800).springify()}>
                        <View style={[
                            ...
                            {
                                backgroundColor: isLight ? 'rgba(109, 47, 255, 0.1)' : 'rgba(255,255,255,0.1)',
