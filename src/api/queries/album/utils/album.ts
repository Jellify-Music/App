...
/**
 * Fetches the number of albums whose `SortName` is less than {@link nameLessThan}, or the total
 * album count when omitted. Used to jump the AZScroller directly to a letter's absolute index
