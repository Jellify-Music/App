...
import { alphabet, alphabetReverse } from '../../../constants/alphabet'
...
export default function AZScroller({
	...
	const alphabetToUse = customAlphabet ?? (reverseOrder ? alphabetReverse : alphabet)
	...
	const handleGestureEnd = () => {
		if (selectedLetter.value) {
			scheduleOnRN(async () => {
				...
				onLetterSelect(selectedLetter.value).then(() => {
